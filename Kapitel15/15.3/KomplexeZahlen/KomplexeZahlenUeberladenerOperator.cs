...
class KomplexeZahlen
{
    public static void Main()
    {
        ...
        Console.WriteLine("erste Zahl: RE " + ersteZahl.RE +
        " IM " + ersteZahl.IM);

        zweiteZahl.RE = 17.5; zweiteZahl.IM = 6.6;
        Console.WriteLine("zweite Zahl: RE " + zweiteZahl.RE +
        " IM " + zweiteZahl.IM);

        Komplex dritteZahl = new Komplex(); //Erzeugung mit new
        dritteZahl = ersteZahl + zweiteZahl;
        //überladener Operator +
        Console.WriteLine("dritte Zahl: RE " + dritteZahl.RE +
        " IM " + dritteZahl.IM);
    }
}
struct Komplex
{
    ...
    public static Komplex operator +(Komplex zahl1, Komplex zahl2)
    {
        Komplex zahl3;
