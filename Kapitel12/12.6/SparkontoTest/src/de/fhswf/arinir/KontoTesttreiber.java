...
class KontoTesttreiber
{
    ...
    private static void testreihe(FileIn inFile, FileOut outFile, String testfall)
    {
        ...
        while (zeile != null)
        {
            if (testfall.equals("KontoKonstruktor"))
                KontoTesttreiber.testfallSparkonto(zeile, outFile);
        ...
        int[] ueberdeckung = Sparkonto.getDurchlauf();
     ...
     * @param outFile
     */
    private static void testfallSparkonto(String zeile, FileOut outFile)
    {
